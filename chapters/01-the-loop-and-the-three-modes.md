...
<!-- → [TABLE: The three modes side by side — columns: Mode, Human presence during execution, Steps that reweight, Characteristic failure mode, Where covered; rows: Augmentation, Automation, Agency — student should see at a glance how the same Loop changes shape across the three contexts] -->
